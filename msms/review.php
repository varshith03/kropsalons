...
<body>
  ...
  <!-- <div class="side">
    <?php echo $ret="select sum(points) from  tblfeedback where sid=$sid and points='5'";
...
?>
  ...
  <div class="side right">
    <div>20</div>
               ...
               <table class="table table-bordered"> <thead> <tr> <th>#</th>  <th>CUSTOMER NAME</th><th>RATINGS</th> <th>COMMENTS</th> </tr> </thead>
<?php
$ret="select points,comments,name from  tblfeedback where sid=$sid ";
$res=mysqli_query($con,$ret);
$cnt=1;
