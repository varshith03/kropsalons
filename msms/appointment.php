...
if(isset($_POST['submit']))
 ...
 for($i=0;$i<sizeof($services);$i++)
	{
    $query=mysqli_query($con,"insert into tblappointment(AptNumber,Name,Email,PhoneNumber,AptDate,AptTime,Services,gender,sid) value('$aptnumber','$name','$email','$phone','$adate','$atime','$services[$i]','$gender','$sid')");
	}
    if ($query) {
...
<head>
    ...
    <title>KROP SALONS || Appointments Form</title>
    <!-- Bootstrap -->
    ...
    <div class="content">
        <div class="container">
            <div class="row">
             ...
             <tr><h3>SALON NAME:</h3><td><h3><?php  echo $row['salon_name'];?></h3></td></tr>   <?php 
$cnt=$cnt+1;
}?>
...
.control-label2 {
    ...
    text-transform: uppercase;
									...
									<div class="col-md-6">
                                        <label class="control-label" for="name">Gender</label><br>
